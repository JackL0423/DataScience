...
#   Not the intelligent way to do things
...
#   This appoach is bound to work eventually, since worst case
#   we go all the way down to just one label
def majority_vote(labels: List[str]) -> str:
    ...
    if num_winners == 1:
        ...
        return majority_vote(labels[:-1])   # try again with the farthest
